...
title = ''
def open_canvas(title_name='', w=int(800), h=int(600), sync=False, full=False):
...
class Font:
    ...
    def draw(self, x, y, str, color=(0,0,0), pivot = None):
        ...
        if pivot == 'c':
            ...
            self.image.draw(x+self.image.w/2, y)
